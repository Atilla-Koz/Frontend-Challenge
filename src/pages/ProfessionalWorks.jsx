...
const T = {
  tr: {
    eyebrow: 'Profesyonel Çalışmalar',
    title: 'Prodüksiyon',
    sub: 'Ticari çekimler, etkinlikler ve hareketli görüntüler.',
    backPhoto: '← Portfolyo',
    backHome: 'Ana Sayfa',
    filterAll: 'Tümü',
    videoSection: 'Video Çalışmalar',
    photoSection: 'Fotoğraf Çalışmalar',
  ...
  en: {
    ...
    title: 'Production',
    sub: 'Commercial shoots, events and moving images.',
    backPhoto: '← Portfolio',
    backHome: 'Home',
    filterAll: 'All',
    videoSection: 'Video Works',
    photoSection: 'Photo Works',
